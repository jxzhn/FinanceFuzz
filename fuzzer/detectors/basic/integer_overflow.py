...
class IntegerOverflowDetector(BaseBasicDetector):
    ...
    def init(self) -> None:
        ...
        self.underflows: dict[str, tuple[int, int]] = {}
        self.compiler_value_negation: bool = False

    def detect_integer_overflow(self, mfe: FuzzingEnvironment, tainted_record: TaintRecord | None, previous_instruction: TracedInstruction | None, current_instruction: TracedInstruction, individual: Individual, transaction_index: int) -> tuple[int, int, Literal['underflow', 'overflow']] | tuple[None, None, None]:
