...
if TYPE_CHECKING:
    ...
    from engine.components.individual import InputDict, Individual
...
class DetectorExecutor:
    ...
    @staticmethod
    def add_error(errors: dict[int, list[ErrorRecord]], pc: int, type: str, individual: Individual, mfe: FuzzingEnvironment, detector: BaseDetector, source_map: SourceMap | None) -> bool:
